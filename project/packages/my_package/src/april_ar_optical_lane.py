...
#             #     # # Adjust velocity and omega for sharp turns
#             #     rospy.loginfo(f"Error: {error}")
#             #     if (error > 20 and error < 100) or (error < 10 and error > -20):  # Threshold for detecting an arc
#             #         v = self.VELOCITY*0.3  # Slow down for better turning
#             #         omega *= 2.5  # Amplify turn rate
#             #         rospy.loginfo(f"Sharp turn detected, error: {error}, omega: {omega}")
                
#             #     # elif error <= 10:  # Threshold for detecting an arc
#             #     #     v = self.VELOCITY*0.3  # Slow down for better turning
#             #     #     omega *= 2.0  # Amplify turn rate
#             #     #     rospy.loginfo(f"Sharp turn detected, error: {error}, omega: {omega}")

#             #     else:
#             #         v = self.VELOCITY
#             #         # omega *= 2  # Amplify turn rate
#             #         # rospy.loginfo(f"Sharp turn detected, error: {error}, omega: {omega}")
...
#             # else:
#             #     # rospy.loginfo(f"Error: {error}")
#             #     # if error < 30:  # Threshold for detecting an arc
#             #     #     v = self.VELOCITY*0.3  # Slow down for better turning
#             #     #     omega *= 4  # Amplify turn rate
#             #     #     rospy.loginfo(f"Sharp turn detected, error: {error}, omega: {omega}")
#             #     # else:
#             #     #     v = self.VELOCITY
